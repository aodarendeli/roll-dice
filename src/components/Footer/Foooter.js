          ...
          <div className='col-lg-8 col-md-12 col-sm-12'>
            ...
            <div className='footer__bottom mt-3'>
              <p>
                ...
                Chainlink. Unliketradinal casinos that operate in black boxes,
                Sx run on smart contracts that are fair,transparent and
                immutable. The platform provides a low-cost and fast going
                experiences throughh the combination of both tradional care game
